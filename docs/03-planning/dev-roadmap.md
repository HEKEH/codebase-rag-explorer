...
- [x] M3-2 空检索与未建索引分支（`3001`、`2001`）`done`
- [x] M3-3 引用白名单生成（不从 LLM 文本反推）`done`

## Phase 4：前端 MVP
- [x] M4-1 仓库导入与索引状态面板 `done`
- [x] M4-2 问答提交流程与结果渲染 `done`
- [x] M4-3 引用代码展示与错误提示体验 `done`

## Phase 5：质量门禁与验收
- [x] M5-1 后端单元/集成/API 最小测试矩阵 `done`
- [x] M5-2 前端组件/Hook 最小测试矩阵 `done`
- [x] M5-3 PRD 验收题集与结果报告 `done`
